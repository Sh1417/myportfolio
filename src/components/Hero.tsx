        ...
        <div id="hero" className="w-full h-screen bg-[#0a192f]">
            ...
            <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
                ...
                <p className=" text-gray-500 py-4 max-w-[600px] text-justify ">
                    I have a combined work experience of 3 years and 10 months with Angular and Javascript. Crafting sleek solutions and conquering bugs, this seasoned dev ensures projects shine!
                ...
                <div className='text-white pt-2 lg:hidden'>
                    ...
                    '>
                            <a href="https://linkedin.com/in/sharath-hari-38b5811b6" target="_blank">LinkedIn</a><FaLinkedin size={25} />
                        </li>
                        <li className='w-full h-[40px] flex justify-between items-center bg-red-600'>
                            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=sharathhari17@gmail.com" target="_blank">Email</a><HiOutlineMail size={25} />
                        </li>
